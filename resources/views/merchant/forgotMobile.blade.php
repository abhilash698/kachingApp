        ...
        <div class="p-l-50 m-l-20 p-r-50 m-r-20 p-t-50 m-t-30 sm-p-l-15 sm-p-r-15 sm-p-t-40">
          {!! Html::image('assets/img/custom/index.png', 'logo' , array('class' => '','width'=>'130')) !!}
           <p class="p-t-35">Forgot Password.</p>
            ...
            @endif
          <!-- START Login Form -->
          <form id="form-login" class="p-t-15" role="form" method='POST' action="/merchant/forgot/mobile">
            {!! csrf_field() !!}
            <!-- START Form Control-->
            ...
            <button class="btn btn-primary btn-cons m-t-10" type="submit">Continue</button>
          </form>
          <!--END Login Form-->
